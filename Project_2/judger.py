...
TASKS = [
    ('Task_1', ['battlefield.cpp', 'bop.cpp','define.cpp','helper.cpp','human_actor.cpp', 'sunny_actor.cpp']),
    ('Task_2', ['battlefield.cpp', 'bop.cpp','define.cpp','helper.cpp','human_actor.cpp', 'rainy_actor.cpp']),
    # ('Task_3', ['engine.cpp', 'main.cpp','property.cpp','skill.cpp','slime.cpp']),
]
...
def compile_and_link(args, task, workdir):
    ...
    src_paths = [
        os.path.join(args.thisdir, 'src', task_name, src)
        for src in srcs
    ]
