...
extern const std::map<Type_T, std::string> typeName;
...
struct Skill {
    enum {
        BACK = 0, Tackle = 1, Claw, Quick, Slap, Sing, Paint, Leaf, Synthesis, Flame, Sunny, Stream, Rainy, Volt, Thunder
    } skill;
